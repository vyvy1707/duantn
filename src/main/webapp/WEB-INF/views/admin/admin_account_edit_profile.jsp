		...
		<div class="container-fluid px-4" style="margin-top: 26px;">
			<section class="row">
				...
				<div class="col-2 mt-4">
					<img class="img-thumbnail rounded hvr-grow-shadow" alt=""
						width="160" height="120" src="/upload/${imgg}" />
				</div>
				<div class="col-6 mt-4 ">
					<div class="card">
						...
						<div class="card-body">
							<form:form action="/admin/UpdateProfile"
								...
								<div class="form-group">
									...
									<form:input type="password" readonly="true"
