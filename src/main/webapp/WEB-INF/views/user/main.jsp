...
<div style="margin-top: 63px;" class="my-data" data-spy="scroll"
	...
	<div  style="margin: auto;width: 80%;">
		...
		<div id="myCarousel" class="carousel slide border"
			...
			<br>
			<img src="/images/blackFriday.gif" class="d-block w-100" alt="">
			
			
			
			<!-- Controls -->
			<a class="carousel-control-prev  " type="" href="#myCarousel" role="button"
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mb-4">
					<div class="card">
						<div class="hovereffect">
							...
							<div class="overlay">
								<h2>
									<s:message code="lo.mn.order" />
								</h2>
								<p>
									<a href="/shoppingCart/add/${item.id}"> <i
										class="fas fa-cart-plus"></i>
									</a> <a href="https://www.facebook.com/ctadzzn"> <i
						...
						<div class="card-body text-center ">
							<h5>
								<a href="/shoppingCart/viewss/${item.id}"><b>${item.name}</b></a>
							</h5>
							...
							đ <br> <a href="/shoppingCart/viewss/${item.id}"><button
									type="button" class="btn btn-danger mt-2 hvr-pulse-shrink">
									<s:message code="lo.mn.buy" />
								</button></a>
						</div>
					</div>
			...
			<div class="row justify-content-center">
				...
				<div class="col-12 col-lg-3 col-sm-4 col-custom-padding last">
					<div class="smart-box">
						...
						<p>Gọi ngay cho chúng tôi khi bạn có thắc mắc: 0385 186 481</p>
					</div>
				</div>
			</div>
		</div>
