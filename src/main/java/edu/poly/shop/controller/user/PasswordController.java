...
public class PasswordController {
	...
	@RequestMapping("/user/editPassword/{id}")
	public String editPassword(Model model, @PathVariable("id") String id) {
		Account item = accountDao.findById(id).get();
		model.addAttribute("ACCOUNTS", item);
		return "user/user_account_password";
	}

	@RequestMapping("/user/updatePassword")
	public String doLogin(@ModelAttribute("ACCOUNTS") Account ac, Model model,
